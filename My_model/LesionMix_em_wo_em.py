...
parser.add_argument('--exp', type=str,
                    default='model_baseline_10/LesionMix_em_wo_em2', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    train_transform = Lesion_and_image_augmentation('/data1/data/GD/LesionMix_km/lesion_warehouse',
                                                    labeled_prop=args.labeled_bs/args.batch_size, init_lesion_count=3,
                                                    argrate=0.6, racalss_flag=False, enhencement_strength="Weak")
