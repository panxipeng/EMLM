...
parser.add_argument('--exp', type=str,
                    default='model_baseline_30/Entropy_Minimization_with_LesionMix_test_new', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    # model1 = torch.load(
    #     '/data1/code/model/LUAD GD/model_baseline_50/Regularized_Dropout/unet/unet_best_model1.pth')
    # model = torch.load(
    #     '/data1/code/model/LIDC/model_baseline_50/Entropy_Minimization_with_LesionMix2/unet/unet_best_model.pth')
    ...
    with open('./EMLM_1_3_loss.txt', 'w') as f:
        for item in loss_list:
            f.write("%s\n" % item)

    with open('./EMLM_1_3_dice.txt', 'w') as f:
